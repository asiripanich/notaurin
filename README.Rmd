...
<!-- badges: start -->
![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/asiripanich/aurin?include_prereleases)
...
You can install the released version of `aurin` from [GitHub](https://github.com/asiripanich/aurin) with:
